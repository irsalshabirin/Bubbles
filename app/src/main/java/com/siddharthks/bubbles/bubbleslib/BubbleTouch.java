...
public class BubbleTouch implements View.OnTouchListener {
    ...
    private BubbleTouch(Builder builder) {
        ...
        animator = new BubbleAnimator.Builder()
                .sizeX(sizeX)
                .sizeY(sizeY)
    ...
    public static final class Builder {
        ...
        public Builder logger(BubbleLogger val) {
            logger = val;
            return this;
        }
        ...
        public BubbleTouch build() {
            return new BubbleTouch(this);
        }
        ...
        public Builder physics(BubbleTouchListener val) {
            physics = val;
            return this;
        }

        public Builder listener(BubbleTouchListener val) {
            listener = val;
            return this;
        }

        public Builder config(BubbleConfig val) {
            config = val;
            return this;
        }
