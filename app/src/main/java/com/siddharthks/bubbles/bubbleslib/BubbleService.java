...
public class BubbleService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        logger = new BubbleLogger().setDebugEnabled(true).setTag(TAG);
    }
    ...
    protected void setupViews() {
        ...
        removeBubbleView = inflater.inflate(R.layout.remove_bubble_view, null);
        expandableView = inflater.inflate(R.layout.expandable_view, null);
    ...
    protected BubbleConfig getConfig() {
        return BubbleConfig.getDefault(getContext());
    }
    ...
    protected void setTouchListener() {
        physics = new BubblePhysics.Builder()
                .sizeX(windowSize.x)
                .sizeY(windowSize.y)
     ...
     */
    public BubbleTouchListener getTouchListener() {
        return new DefaultBubbleTouchListener() {
            @Override
