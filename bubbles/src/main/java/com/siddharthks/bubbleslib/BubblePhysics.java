...
public class BubblePhysics extends DefaultBubbleTouchListener {
    ...
    private BubblePhysics(Builder builder) {
        sizeX = builder.sizeX;
        sizeY = builder.sizeY;
    ...
    public void onUp(float x, float y) {
        addSelectively(x, y);
        Log.d(BubblePhysics.class.getSimpleName(), previous.toString());
    ...
    public static final class Builder {
        ...
        public BubblePhysics build() {
            return new BubblePhysics(this);
        }
    }
}
